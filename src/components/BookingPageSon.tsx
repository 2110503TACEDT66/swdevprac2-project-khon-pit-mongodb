...
export default function BookingPagSon({dentistJson}:{dentistJson:DentistJson}){
    ...
    return(
        <div>
            <div className="w-[100%] flex flex-row justify-center my-5 items-center space-y">Date : <DateReserve onDateChange={(value:Dayjs)=>{let vv= dayjs(value).format("YYYY-MM-DDTHH:mm:ss.SSS")+'Z';dispatch(changeBookingDate(vv))}}/></div>
